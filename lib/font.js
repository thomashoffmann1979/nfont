var OS2 = require('./tables/os2').OS2,
    ...
    HMTX  = require('./tables/hmtx').HMTX,
    MAXP  = require('./tables/maxp').MAXP,
    SVG  = require('./tables/svg').SVG,
    fs = require('fs'),
    butil = require('./butil'),
...
butil.inherits(Font,EventEmitter,{
    ...
    fs.readFile(fileName,function(err,buffer){
        ...
        for (i=0; i < me.numberOfTables; i+=1 ){
            ...
            if (typeof me.READER[item.tag]=='undefined'){
                ...
                fr.once('readed',me.tableReaded.bind(me,item.tag));
                fr.read( item.offset );
            }
...
Font.prototype.tableReaded = function(tableName,reader){
    var me = this;
    me.tables[tableName]=reader;
    console.log(tableName+'Readed');
    me.emit(tableName+'Readed');
}
...
Font.prototype.READER['hmtx'] = HMTX;
Font.prototype.READER['maxp'] = MAXP;
Font.prototype.READER['SVG '] = SVG;
